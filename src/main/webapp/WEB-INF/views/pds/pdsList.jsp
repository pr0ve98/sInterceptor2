...
<div class="container">
  ...
  <hr/>
    <a href="${ctp}/pds/pdsInput" class="btn btn-primary">자료실글올리기</a>
    <a href="${ctp}/pds/pdsUpdate" class="btn btn-warning">자료실수정하기</a>
    <a href="javascript:pdsDelete()" class="btn btn-danger">자료실삭제하기</a>
    <a href="pdsDownload" class="btn btn-info">자료다운하기</a>
  <hr/>
</div>
<p><br/></p>
</body>
